Basic mobile store application where used can explore different mobiles and can add to cart. Beginner level project to understand the basic state management in redux.
